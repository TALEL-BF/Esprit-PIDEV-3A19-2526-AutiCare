...
class PredictionController extends AbstractController
{
    ...
    public function index(EventRepository $eventRepository, EventAIPredictor $predictor): Response
    {
        ...
        foreach ($events as $event) {
            ...
            $result = $predictor->predictAutismScoreWithConfidence($event);
            $score = $result['score'];
        ...
        $averageConfidence = $totalEvents > 0 ? round($totalConfidence / $totalEvents, 2) : 0;
    ...
    public function refreshPredictions(EventRepository $eventRepository, EventAIPredictor $predictor): JsonResponse
    {
        ...
        foreach ($events as $event) {
            ...
            $predictions[] = [
                ...
                'level' => $this->getScoreLevel($result['score']),
                'level_class' => $this->getScoreClass($result['score'])
            ];
        }
