...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function setCreatedAt(\DateTimeInterface|string|null $createdAt): static
    {
        ...
        elseif (is_string($createdAt)) { $this->createdAt = new \DateTime($createdAt); }
    ...
    public function getOtpExpiry(): ?\DateTimeInterface { return $this->otpExpiry; }
    public function setOtpExpiry(?\DateTimeInterface $otpExpiry): static { $this->otpExpiry = $otpExpiry; return $this; }
    public function isOtpValid(): bool
    {
        if (!$this->otpCode || !$this->otpExpiry) { return false; }
        return $this->otpExpiry > new \DateTime();
    }
